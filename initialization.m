function initialization()
    ...
    [ini_results, ini_mpc, ini_failure] = n1_contingency(sim_settings, -1, generation_outages, load_data_obj, mpc, gen_array, block_dispatch, mpopt, sim_settings.start_hour, sim_settings.simulation_hours);
    ini_mpc = ini_mpc(~cellfun('isempty', ini_mpc));
    ini_failure = ini_failure(~cellfun('isempty', ini_failure));
