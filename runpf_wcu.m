function [MVAbase, bus, gen, branch, success, et] = ...
                runpf_wcu(casedata, mpopt, fname, solvedcase)
       ...
       if nargin < 3
          ...
          if nargin < 2
             mpopt = mpoption;       %% use default options
              if nargin < 1
                 casedata = 'case118_CAPER_PeakLoad.m'; %% default data file is 'case9.m'
              end
          end
       end
    end
...
%{
Notes from Brandon
I have modified this block here to take an external variable input "load"
This is used to scale the values in the below commands so that no longer
have to do this internally.
%}
mpc = loadcase(casedata);

% mpc.branch(114, 11) = 0 how to turn off a branch
...
%%This line removes table vomit from the output window
if (mpopt.verbose > 0)
